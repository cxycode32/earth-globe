...
export const runApp = (app, scene, renderer, camera, enableAnimation = false, uniforms = getDefaultUniforms(), composer = null) => {
    ...
    app.initScene()
        .then(() => {
            ...
            veil.style.transition = veil.style.transition || "opacity 450ms ease, visibility 0ms linear 450ms";
            progressBar.style.transition = progressBar.style.transition || "opacity 450ms ease, visibility 0ms linear 450ms";
